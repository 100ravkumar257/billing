...
<html lang="en">
    <head>
        ...
        <!-- Main CSS -->
        <link rel="stylesheet" href="/assets/admin/css/style.css?v=<?php echo  time();?>">    
    </head>
    <body>
                ...
                <div class="container">
                    <div class="loginbox">
                        ...
                        <div class="login-left">
                            ...
                            <img src="{{ asset('frontend/retailer/images/png-file.png') }}" alt="Product" height="220px">
                        ...
                        <div class="login-right">
                            <div class="login-right-wrap">
                                ...
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                    <button class="btn-block" type="submit" style="
                                        background: linear-gradient(135deg, #ff7518,rgb(248, 163, 88)); 
                                        color:black;
                                        font-size: 16px; 
                                        border: none; 
                                        border-radius: 5px; 
