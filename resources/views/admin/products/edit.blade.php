    ...
    <div class="page-header">
        <div class="card breadcrumb-card">
            <div class="row justify-content-between align-content-between" style="height: 100%;">
                <div class="col-md-6">
                    <h3 class="page-title">{{ __('product.edit.title') }}</h3>
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active-breadcrumb">
                            <a href="{{ route('products.edit', $product->id) }}">{{ __('product.edit.title') }}</a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="category_id" id="category_id" class="form-control @error('category_id') form-control-error @enderror" required>
                                            <option value="" disabled>{{ __('default.form.choose_category') }}</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="brand_id" id="brand_id" class="form-control @error('brand_id') form-control-error @enderror" required>
                                            <option value="" disabled>{{ __('default.form.choose_brand') }}</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control @error('name') form-control-error @enderror" required value="{{ old('name', $product->name) }}">
                                        @error('name')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <!-- <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="slug" id="slug" class="form-control @error('slug') form-control-error @enderror" required value="{{ old('slug', $product->slug) }}" style="display: none;">
                                        @error('slug')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    <!-- </div>
                                   ...
                                   <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="density" id="density" class="form-control @error('density') form-control-error @enderror" required value="{{ old('density', $product->density) }}">
                                        @error('density')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="3" name="short_desc" id="short_desc" class="form-control @error('short_desc') form-control-error @enderror" required>{{ old('short_desc', $product->short_desc) }}</textarea>
                                        @error('short_desc')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="image">{{ __('default.form.upload_image') }}:</label>
                                        <input type="file" name="image" id="image" class="form-control @error('image') form-control-error @enderror" value="{{ old('image') }}">
                                        @if($product->image)
