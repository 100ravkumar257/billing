...
@section('content')
    <form method="post" action="{{ route('shades.store') }}" enctype="multipart/form-data">
        @csrf()
                ...
                <div class="row justify-content-between align-content-between" style="height: 100%;">
                    <div class="col-md-6">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('currencies.index') }}">{{ __('shades.index.title') }}</a>
                            </li>
                            <li class="breadcrumb-item active-breadcrumb">
                                <a href="{{ route('currencies.create') }}">{{ __('shades.create.title') }}</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-3">
