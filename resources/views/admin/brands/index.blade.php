				...
				<div class="col-md-6">
					...
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item active-breadcrumb">
							<a href="{{ route('categories.index') }}">{{ __('brands.index.title') }}</a>
						</li>
					</ul>
				</div>
                @if (Gate::check('brand-create'))
                    <div class="col-md-3">
                        <div class="create-btn pull-right">
                            <a href="{{ route('brands.create') }}" class="btn custom-create-btn">{{ __('brands.form.add-button') }}</a>
                        </div>                 
                    </div>
                @endif
			</div>
