...
@section('content')
	<form method="post" action="{{ route('brands.update', $row->id) }}" enctype="multipart/form-data" id="brands_edit_form">
		@csrf()
				...
				<div class="row justify-content-between align-content-between" style="height: 100%;">
					<div class="col-md-6">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item">
								<a href="{{ route('brands.index') }}">{{ __('brands.index.title') }}</a>
							</li>
							<li class="breadcrumb-item active-breadcrumb">
								<a href="{{ route('brands.edit', $row->id) }}">{{ __('brands.edit.title') }} - ({{ $row->name }})</a>
							</li>
						</ul>
					</div>
					<div class="col-md-3">
				...
				<div class="col-md-12">
					...
					<div class="card">
						<!-- <div class="card-header">
							<h5 class="card-title">
								({{ $row->name }}) Product Brands Information
							</h5>
						</div> -->
						...
						<div class="card-body">
							<div class="row">
								...
								<div class="form-group">
                                    ...
                                    @if($row->image)
                                        <div class="form-group">
                                            <img src="{{ asset('storage/brands/' . $row->image) }}" alt="Current Brand Image" width="100" height="100">
                                        </div>
                                    @else
                                    <p>No Image </p>
                                    @endif
