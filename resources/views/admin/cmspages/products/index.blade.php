                ...
                @if (Gate::check('product-create'))
                    <div class="col-md-3">
                        <div class="create-btn pull-right">
                            <a href="{{ route('products.create') }}" class="btn custom-create-btn">{{ __('Add-New-Product') }}</a>
                        </div>
                    </div>
                @endif
            </div>
        ...
        $('#table').DataTable({
            ...
            columns: [
                ...
                { data: 'image', name: 'image', render: function(data, type, row) {
                    if (data) {
                        return `<img src="{{ asset('storage/products') }}/${data}" alt="${row.name}" width="50" height="50">`;
                    }
                    return 'No Image'; 
                }},
                { data: 'name', name: 'name' },
