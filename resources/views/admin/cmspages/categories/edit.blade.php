...
@section('content')
	<form method="post" action="{{ route('categories.update', $cmscategory->id) }}"enctype="multipart/form-data">
		@csrf()
				...
				<div class="row justify-content-between align-content-between" style="height: 100%;">
					<div class="col-md-6">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item">
								<a href="{{ route('categories.index') }}">{{ __('cmscategory.index.title') }}</a>
							</li>
							<li class="breadcrumb-item active-breadcrumb">
								<a href="{{ route('categories.edit', $cmscategory->id) }}">{{ __('cmscategory.edit.title') }} - ({{ $cmscategory->name }})</a>
							</li>
						</ul>
					</div>
					<div class="col-md-3">
						...
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
                                    ...
                                    @if($cmscategory->image)
                                        <div class="form-group">
                                            <img src="{{ asset('storage/categary/' . $cmscategory->image) }}" alt="Current Brand Image" width="100" height="100">
                                        </div>
                                    @else
									<p>No Image </p>
                                    @endif
