...
Breadcrumbs::for('products.index', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(__('products.breadcrumb.index'), route('products.index'));
});

Breadcrumbs::for('products.create', function ($trail) {
    $trail->parent('products.index');
    $trail->push(__('products.breadcrumb.create'), route('products.create'));
});

Breadcrumbs::for('products.edit', function ($trail) {
    $trail->parent('products.index');
    $trail->push(__('products.breadcrumb.edit'), route('products.edit', '$products->id'));
});